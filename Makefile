...
dev-web:
		flutter run --target lib/main_development.dart -d chrome
...
staging-web:
		flutter run --target lib/main_staging.dart -d chrome

run_web:
		flutter run --target lib/main_production.dart -d chrome
...
delete-gen:
		find ./ -name '*.g.dart' -delete && find ./ -name '*.freezed.dart' -delete

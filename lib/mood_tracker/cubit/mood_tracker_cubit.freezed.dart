...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MoodTrackerState);
}
...
/// @nodoc
class $MoodTrackerStateCopyWith<$Res>  {
$MoodTrackerStateCopyWith(MoodTrackerState _, $Res Function(MoodTrackerState) __);
}


/// Adds pattern-matching-related methods to [MoodTrackerState].
extension MoodTrackerStatePatterns on MoodTrackerState {
...
class _Initial implements MoodTrackerState {
  const _Initial();
...
@override
String toString() {
  return 'MoodTrackerState.initial()';
}
